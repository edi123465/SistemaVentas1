...
function Header()
{
    ...
    $this->Cell(140, 10, utf8_decode('Este reporte genera una impresión de todas las reservas para la cédula ingresada por filtro en la Base de Datos'), 0, 0, 'C');
    $this->Ln(5);
